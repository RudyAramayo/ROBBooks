...
\ROBChapterPhoto{Mission 1}{Start with loads, not shapes}{2024-nearly-assembled-base.jpg}
...
\ROBChapterPhoto{Mission 5}{Prototype materials answer questions}{2022-drilling-metal-rail.jpg}
...
\ROBChapterPhoto{Mission 6}{Plan the cut before making chips}{2024-caliper-tread-measurement.jpg}
...
\ROBChapterPhoto{Mission 7}{Assembly order is part of the design}{2025-rear-electronics-bay.jpg}
...
\ROBPhotoTwo{2025-labeled-cables.jpg}{Temporary labels make a complex teardown easier to understand. A permanent harness should use durable IDs and an updated schematic.}{2025-rear-electronics-bay.jpg}{Dense wiring makes connector access, bend radius, heat, abrasion, and fault isolation design problems.}
...
\ROBPhoto[0.50\textheight]{2022-chassis-wiring-overhead.jpg}{An overhead build view is a dependency map made physical: each cable, bracket, board, and cover changes what can be installed or reached next.}
