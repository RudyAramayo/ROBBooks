...
\hypersetup{
  ...
  pdfsubject={An implementation-level history and Swift and Objective-C guide to Cerebro hardware IO, perception, models, identity, private Messages, recording, video, and bounded autonomy},
  pdfkeywords={Cerebro history, Swift, Objective-C, macOS, serial, OpenNI, Kinect, AVFoundation, Vision, SceneKit, MLX, Gemini, Luxonis, AdaFace, Messages, recording, Insta360, H.264, robotics}
}
