...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{amber\markdownRendererUnderscore{}b1.urdf} in the \markdownRendererCodeSpan{Amber URDF} folder defines the independent arm. \markdownRendererCodeSpan{DualArm.urdf} in the captured \markdownRendererCodeSpan{urdf/dual\markdownRendererUnderscore{}b1} folder defines the combined model. The code map supplies full paths and side-specific alternatives.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{initCan.sh} in \markdownRendererCodeSpan{amber\markdownRendererUnderscore{}core/init} and its adjacent \markdownRendererCodeSpan{SerialNumber.txt}. An older \markdownRendererCodeSpan{amber/initCAN.sh} also exists; compare rather than merging their assumptions. The code map gives both full paths.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{amber\markdownRendererUnderscore{}robot.py} in Cerebro's AMBER V2 API provides the high-level wrapper. Exact packed structures live in its \markdownRendererCodeSpan{basic\markdownRendererUnderscore{}cmd} directory: \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}1.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}4.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}6.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}7.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}9.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}10.py}, and \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}110.py}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} the captured \markdownRendererCodeSpan{sin\markdownRendererUnderscore{}wave/rawLcm} directory contains human-readable \markdownRendererCodeSpan{.lcm} schemas. Nearby \markdownRendererCodeSpan{lcmTypes} Python files are generated outputs; edit and regenerate from the schema definitions.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} import behavior comes from \markdownRendererCodeSpan{amber\markdownRendererUnderscore{}api/\markdownRendererUnderscore{}\markdownRendererUnderscore{}init\markdownRendererUnderscore{}\markdownRendererUnderscore{}.py} and \markdownRendererCodeSpan{amber\markdownRendererUnderscore{}robot.py} inside Cerebro's AMBER V2 API. Read the directory-local \markdownRendererCodeSpan{README.md} and \markdownRendererCodeSpan{LICENSE} before installing or redistributing it.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} task-facing scripts are in Cerebro's \markdownRendererCodeSpan{TaskControllers/Amber V2 API} directory; reusable source is in \markdownRendererCodeSpan{Amber-PythonAPI/Amber V2 API}. The chapter recommends consolidating these entry points. Full paths are in the code map.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
