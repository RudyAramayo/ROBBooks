...
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{AmberHomeFolder/amber/L-10/launch.json} and \markdownRendererCodeSpan{AmberHomeFolder/amber/R-11/launch.json}. This chapter derives the left/right topology from those two captured configuration files.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Amber URDF/amber\markdownRendererUnderscore{}b1.urdf} for the independent single-arm chain, then \markdownRendererCodeSpan{AmberHomeFolder/amber/amber\markdownRendererUnderscore{}core/urdf/dual\markdownRendererUnderscore{}b1/DualArm.urdf} for the combined model. The dual directory also contains side-specific alternatives.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{AmberHomeFolder/amber/amber\markdownRendererUnderscore{}core/init/initCan.sh} and its adjacent \markdownRendererCodeSpan{SerialNumber.txt}. An older alternative also exists at \markdownRendererCodeSpan{AmberHomeFolder/amber/initCAN.sh}; compare rather than merging their assumptions.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} return to the two \markdownRendererCodeSpan{launch.json} files. The executables beside them are captured binaries, not readable source; the book documents their configured boundary without claiming to analyze their internal CAN implementation.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Cerebro/Amber-PythonAPI/Amber V2 API/amber\markdownRendererUnderscore{}api/amber\markdownRendererUnderscore{}robot.py} provides the high-level wrapper. Exact packed structures live in its \markdownRendererCodeSpan{basic\markdownRendererUnderscore{}cmd/cmd\markdownRendererUnderscore{}1.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}4.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}6.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}7.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}9.py}, \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}10.py}, and \markdownRendererCodeSpan{cmd\markdownRendererUnderscore{}110.py} files.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererUlBegin
\markdownRendererUlItem \markdownRendererStrongEmphasis{1 — status:} no request payload. The reply carries eight joint positions, eight joint speeds, six Cartesian positions, six Cartesian speeds, and arm angle.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{4 — joint move:} eight floats plus a duration float. The reply carries a one-byte response.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{6 — Cartesian move:} XYZ, RPY, arm angle, and duration as floats. The reply carries a one-byte response.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{7 — calibration:} an unsigned 32-bit actuator number. The reply carries a one-byte response.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{9 — gripper:} unsigned 16-bit action, unsigned 16-bit intensity, and Boolean version. The reply carries a one-byte response.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{10 — set mode:} an unsigned 16-bit mode. The reply carries a one-byte response.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{110 — get mode:} no request payload. The reply carries seven unsigned 16-bit mode values.\markdownRendererUlItemEnd 
\markdownRendererUlEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{AmberHomeFolder/amber/sin\markdownRendererUnderscore{}wave/rawLcm/*.lcm} contains the human-readable LCM schemas. Generated Python types under nearby \markdownRendererCodeSpan{lcmTypes/} are derived outputs; edit and regenerate from the \markdownRendererCodeSpan{.lcm} definitions.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} import behavior comes from \markdownRendererCodeSpan{Cerebro/Amber-PythonAPI/Amber V2 API/amber\markdownRendererUnderscore{}api/\markdownRendererUnderscore{}\markdownRendererUnderscore{}init\markdownRendererUnderscore{}\markdownRendererUnderscore{}.py} and \markdownRendererCodeSpan{amber\markdownRendererUnderscore{}robot.py}. Read the directory-local \markdownRendererCodeSpan{README.md} and \markdownRendererCodeSpan{LICENSE} before installing or redistributing it.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererUlBegin
\markdownRendererUlItem \markdownRendererStrongEmphasis{No \markdownRendererCodeSpan{can10} or \markdownRendererCodeSpan{can11}:} inspect adapter identity, udev/service state, \markdownRendererCodeSpan{slcand}, and link state. Do not yet conclude that arm electronics failed.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{Core will not start:} inspect working directory, launch JSON, URDF and mesh paths, and libraries. Do not yet conclude that CAN is defective.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{UDP timeout:} inspect the process, listener, address, port, firewall, and route. Do not yet conclude that the arm is powered off.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{Wrong arm responds:} inspect endpoint, port, prefix, CAN mapping, and physical label. Do not yet conclude that joint signs are correct.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{Model bends backward:} inspect side convention, joints 2/4/6 mapping, zero, and URDF selection. Do not yet conclude that hardware must be rewired.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{Status jumps at boot:} inspect zeroing state, mode transition, and packet validation. Do not yet conclude that visual pose is trustworthy.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{LCM silence:} inspect multicast interface, route, channel prefix, and schema version. Do not yet conclude that UDP is also broken.\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererStrongEmphasis{Gripper does nothing:} inspect actuator 8 identity, required calibration, mode, and response validation. Do not respond by assuming higher intensity is safe.\markdownRendererUlItemEnd 
\markdownRendererUlEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} current task-facing AMBER scripts are under \markdownRendererCodeSpan{Cerebro/Cerebro/TaskControllers/Amber V2 API/}; the reusable API source is under \markdownRendererCodeSpan{Cerebro/Amber-PythonAPI/Amber V2 API/}. The chapter recommends consolidating these entry points rather than presenting every script as an independent protocol definition.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
