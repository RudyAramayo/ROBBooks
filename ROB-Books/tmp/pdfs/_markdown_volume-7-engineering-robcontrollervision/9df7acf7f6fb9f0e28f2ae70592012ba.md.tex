...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{ROBControllerVision.xcodeproj/project.pbxproj} and \markdownRendererCodeSpan{Packages/ROBControlCore/Package.swift}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererTable{}{4}{2}{dd}{{Product}{Responsibility}}{{\markdownRendererCodeSpan{ROBControlCore}}{pure domain types, session state, leases, dead-man logic, simulator, and video-domain contracts}}{{\markdownRendererCodeSpan{ROBCerebroTransport}}{Network.framework, Security.framework, pairing, discovery, pinned TLS, legacy control compatibility, and the separate video client}}{{\markdownRendererCodeSpan{ROBVideoPipeline}}{bounded media channels, H.264 encoding/decoding support, validation, sample-buffer construction, and synthetic video}}\markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Packages/ROBControlCore/Sources/ROBControlCore/Connection/RobotSession.swift} and \markdownRendererCodeSpan{ConnectionModels.swift}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Control/DeadManController.swift} and \markdownRendererCodeSpan{Tests/ROBControlCoreTests/DeadManControllerTests.swift}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}The app declares both \markdownRendererCodeSpan{SpatialGamepad} and \markdownRendererCodeSpan{ExtendedGamepad} profiles. \markdownRendererCodeSpan{GameControllerInput} observes connect/disconnect notifications, configures already-connected devices, starts wireless discovery, and stores state by \markdownRendererCodeSpan{ObjectIdentifier}.\markdownRendererParagraphSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Features/Control/ControlPanel.swift} and \markdownRendererCodeSpan{RobotViewModel.beginVirtualMotion()}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Pairing/ROBCerebroCredential.swift}, \markdownRendererCodeSpan{ROBCerebroPairingStore.swift}, \markdownRendererCodeSpan{ROBCerebroPinnedTLS.swift}, \markdownRendererCodeSpan{Control/ROBControlDiscovery.swift}, and \markdownRendererCodeSpan{CerebroPairingSheet.swift}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{CerebroRobotTransport.swift}, \markdownRendererCodeSpan{Control/ROBControlClient.swift}, \markdownRendererCodeSpan{Video/ROBVideoClient.swift}, and both discovery files.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}Network.framework's \markdownRendererCodeSpan{NWProtocolFramerImplementation} separates message boundaries from stream reads. \markdownRendererCodeSpan{parseInput} first waits for an exact header; \markdownRendererCodeSpan{deliverInputNoCopy} delivers one validated payload with message metadata. Output writes the header and payload without copying when possible.\markdownRendererParagraphSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Video/EncodedVideoProtocol.swift}, \markdownRendererCodeSpan{H264SampleBufferFactory.swift}, and \markdownRendererCodeSpan{H264VideoReceiver.swift}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererCodeSpan{H264SampleBufferFactory} creates a \markdownRendererCodeSpan{CMVideoFormatDescription} from parameter sets and constructs timed \markdownRendererCodeSpan{CMSampleBuffer} values from AVCC payload. It validates expected dimensions rather than trusting the bitstream to allocate arbitrary surfaces.\markdownRendererParagraphSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{ROBVideoPipeline/H264VideoReceiver.swift} and \markdownRendererCodeSpan{Platform/Video/VideoPipelineCoordinator.swift}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Platform/Video/SampleBufferVideoView.swift} and \markdownRendererCodeSpan{Features/Video/VideoPanel.swift}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Platform/VisionSpeechInput.swift}, \markdownRendererCodeSpan{Features/Control/OperatorSpeechPanel.swift}, \markdownRendererCodeSpan{RobotViewModel.sendOperatorText()}, and \markdownRendererCodeSpan{ControlProtocol.swift}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}The input first requests Speech authorization, then microphone permission. It creates a recognizer for \markdownRendererCodeSpan{Locale.current}, verifies availability, enables partial results, and requires on-device recognition when the device supports it:\markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{ConnectionStatusView.swift}, \markdownRendererCodeSpan{TelemetryPanel.swift}, \markdownRendererCodeSpan{ROBCerebroTransportError.swift}, and video pipeline error types.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
