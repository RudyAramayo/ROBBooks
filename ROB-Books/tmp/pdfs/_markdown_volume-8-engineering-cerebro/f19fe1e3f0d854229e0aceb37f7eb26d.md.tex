...
{}\markdownRendererTable{}{11}{3}{ddd}{{Layer}{Principal implementation}{Responsibility}}{{Application shell}{\markdownRendererCodeSpan{AppDelegate.m}, \markdownRendererCodeSpan{ROBMainWindowController.m}}{lifecycle, windows, service startup, dependency checks}}{{Operator coordination}{\markdownRendererCodeSpan{ROBMainViewController.mm}}{camera, speech, transport, stage show, robot state}}{{Physical I/O}{\markdownRendererCodeSpan{ROBSerialBox.h/.m}}{Base Arduino, Maestro, Tic, historical serial roles, AMBER helpers}}{{Camera abstraction}{\markdownRendererCodeSpan{CameraManager.swift}}{AVFoundation and supervised DepthAI provider lifecycle}}{{Perception/UI}{\markdownRendererCodeSpan{CameraViewController.swift}}{Vision requests, RGB/depth display, SceneKit overlays}}{{Local intelligence}{\markdownRendererCodeSpan{ROBMLXRuntime.swift}}{MLX LLM, VLM sampling, embeddings, bounded semantic memory}}{{Cloud intelligence}{\markdownRendererCodeSpan{ROBAI.swift}, \markdownRendererCodeSpan{GeminiRoboticsProtocol.swift}}{Gemini Live session, audio/video adapters, tools, diagnostics}}{{Typed world state}{\markdownRendererCodeSpan{ROBSceneSnapshot.swift}}{people, objects, gestures, free space, arm/camera pose, confidence}}{{Performance engine}{\markdownRendererCodeSpan{ROBStageShow*.swift}, \markdownRendererCodeSpan{ROBSaberChoreography.swift}}{validated shows, cue state machine, safe fallbacks, gestures}}{{Spatial remote}{sibling \markdownRendererCodeSpan{ROBControllerVision/}}{Vision Pro input, paired control, video decoding, operator UI}}\markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Cerebro.xcodeproj/project.xcworkspace/xcshareddata/swiftpm/Package.resolved}, \markdownRendererCodeSpan{Cerebro/PythonRequirements.txt}, and \markdownRendererCodeSpan{README.md}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{Cerebro/ROBNiTEManager/}, \markdownRendererCodeSpan{Cerebro/TaskControllers/ROBNiTEManager.mm}, \markdownRendererCodeSpan{FreenectPCL.mm}, \markdownRendererCodeSpan{k2g.h}, \markdownRendererCodeSpan{viewer.*}, shader files, duplicated \markdownRendererCodeSpan{* 2.*} artifacts, and the initial repository commit \markdownRendererCodeSpan{4c4f1d4} dated 2025-08-05.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
...
{}\markdownRendererBlockQuoteBegin
\markdownRendererStrongEmphasis{SOURCE TRAIL — ANALYZING NOW:} \markdownRendererCodeSpan{ROBStageShowProtocol.swift}, \markdownRendererCodeSpan{ROBStageShowCoordinator.swift}, \markdownRendererCodeSpan{ROBStageShowWindowController.swift}, \markdownRendererCodeSpan{StageShows/OrbitusTenMinuteComedy.robshow.json}, and \markdownRendererCodeSpan{Tests/ROBStageShowFixtureTests.swift}.\markdownRendererBlockQuoteEnd \markdownRendererInterblockSeparator
