...
**Checksum manifest:** `publication/reviewed-preschool-epubs.sha256`

This record covers the ten reflowable EPUB 3 editions in ROB's Little Helper
Library. It is separate from the byte-bound review of the original Building
R.O.B. catalog.
...
- EPUBCheck 5.3.0 reports zero errors and zero warnings for every edition.
- The repository structural audit confirms the package identifier, reading order, table of contents, headings, image alternative text, accessibility metadata, and illustration constraints.
...
Apple Books import, Rights and Pricing, Apple-assigned identifiers, automatically
generated samples, and device review on iPhone and iPad remain open until the
Publishing Portal and Apple Books applications provide evidence. Passing the
automated checks and the macOS spot check does not claim Apple approval or store
availability.

## DAISY Ace result

Passed on 2026-09-10: ten EPUBs, zero automated violations.
